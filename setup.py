...
setup(
    name='Roblocks',
    description="Blocks of robots for the organization.",
    ...
    entry_points="""
    [console_scripts]
    roblocks=roblocks.cli:cli
    """,
    python_requires=">=0.0.1",
    license='GPLv3',  # noqa
    author='Bit-a-Bit',
    author_email='github@bit-a-bit.info',
    # Use the URL to the github repo.
    url= 'https://github.com/Bit-a-Bit-gh/roblocks',
    download_url=(
        f'https://github.com/Bit-a-Bit-gh/'
        f'roblocks/archive/{version}.tar.gz'
    ),
    keywords=[
